...
```{r "3_5",fig.height=6, fig.width=8}
library("ggplot2")
library("dplyr")
...
```{r "4_7",fig.height=6, fig.width=8}
library("ggplot2")
...
Quiz: Wie hoch ist der relative Rückgang der Unfälle im ersten Monat nach der Einführung eines starken Verbots?
