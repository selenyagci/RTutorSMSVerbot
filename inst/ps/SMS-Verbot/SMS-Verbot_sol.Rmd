...
+ **Abruf der Modelle:** Innerhalb der Schleife werden für jede Iteration drei Modelle (mod_a, mod_b, mod_c) dynamisch abgerufen. Die Funktion `paste0()` kombiniert mehrere Zeichenketten ohne Trennzeichen, um einen dynamischen Modellnamen zu erstellen, beispielsweise `mod1a` für `i = 1`). Die Funktion `get()` ruft dann das Modellobjekt anhand dieses erzeugten Namens ab. 
