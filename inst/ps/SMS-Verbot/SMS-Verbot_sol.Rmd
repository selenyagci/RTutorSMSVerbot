...
sc:
- Im Vergleich zur Kontrollgruppe führt das SMS-Verbot in der Behandlungsgruppe zu einer Reduktion der tödlichen Verkehrsunfälle mit einem einzelnen Fahrzeug und einem einzelnen Insassen um durchschnittlich 0,574 Fällen pro Monat, ohne Berücksichtigung des Zeitpunkts der Einführung.
...
- Nach Einführung des SMS-Verbots steigt die durchschnittliche Anzahl der tödlichen Verkehrsunfälle mit einem einzelnen Fahrzeug und einem einzelnen Insassen pro Monat um genau 0,574 in allen US-Bundesstaaten, unabhängig davon, ob sie ein SMS-Verbot eingeführt hatten oder nicht.
...
sc:
- Im Vergleich zur Kontrollgruppe führt das SMS-Verbot in den Bundesstaaten, die das Verbot eingeführt haben, zu einer Reduktion der Verkehrsunfälle mit einem einzelnen Fahrzeug und einem einzelnen Insassen um 3,7 Prozent.*
- Im Vergleich zur Kontrollgruppe führt das SMS-Verbot in den Bundesstaaten, die das Verbot eingeführt haben, zu einer Reduktion der Verkehrsunfälle mit einem einzelnen Fahrzeug und einem einzelnen Insassen um 0,037 Prozent. 
- Im Vergleich zur Kontrollgruppe führt das SMS-Verbot in den Bundesstaaten, die das Verbot eingeführt haben, zu einer Erhöhung der Verkehrsunfälle mit einem einzelnen Fahrzeug und einem einzelnen Insassen um 3,7 Prozent. 
- Im Vergleich zur Kontrollgruppe führt das SMS-Verbot in den Bundesstaaten, die das Verbot eingeführt haben, zu einer Erhöhung der Verkehrsunfälle mit einem einzelnen Fahrzeug und einem einzelnen Insassen um 0,037 Prozent. 
...
In der **ersten Regression** (siehe Nummer 1) legt der negative Koeffizient nahe, dass das SMS-Verbot zu einer Reduktion tödlicher Verkehrsunfälle mit einem einzelnen Fahrzeug und einem einzelnen Insassen führt. Besonders deutlich wird diese Verringerung bei einem **starken** SMS-Verbot, wie in der **zweiten Regression** (siehe Nummer 2) zu erkennen ist. Der hochsignifikante negative Koeffizient auf dem 1 %-Niveau deutet auf einen Rückgang um $8,1$ % hin und weist im Vergleich zu den anderen Modellen den stärksten negativen Effekt auf. 
